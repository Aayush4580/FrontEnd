...
public class CategoryController {
	...
	//need to add getall ctegoryList
	...
	public ModelAndView showList(){
		...
		//category.setCategoryList(new <Category>(categoryDAO.list()));
		//wrapper.setUsers(new ArrayList<User>(userDao.findAll()));
	    
	    
		//model.addObject("categoryList", showList());
			...
			@RequestParam("name") String name,  @RequestParam("description") String desc)
	{
		...
		if (categoryDAO.getCategoryByID(id) ==null)
		{
			...
			mv.addObject("message", "Category does not exist with this id " +id);
			return mv;
